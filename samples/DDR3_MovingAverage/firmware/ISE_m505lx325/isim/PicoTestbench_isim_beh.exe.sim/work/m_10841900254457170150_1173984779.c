...
#endif
static const char *ng0 = "/home/albertng/Documents/SmithWaterman/samples/DDR3_MovingAverage/firmware/ISE_m505lx325/source/coregen-LX325T/mig_M505_DDR3/rtl/clocking/mig_7series_v1_8_infrastructure.v";
static const char *ng1 = "############# Write Clocks PLLE2_ADV Parameters #############\n";
static const char *ng2 = "nCK_PER_CLK      = %7d";
static const char *ng3 = "CLK_PERIOD       = %7d";
static const char *ng4 = "CLKIN1_PERIOD    = %7.3f";
static const char *ng5 = "DIVCLK_DIVIDE    = %7d";
static const char *ng6 = "CLKFBOUT_MULT    = %7d";
static const char *ng7 = "VCO_PERIOD       = %7d";
static const char *ng8 = "CLKOUT0_DIVIDE_F = %7d";
static const char *ng9 = "CLKOUT1_DIVIDE   = %7d";
static const char *ng10 = "CLKOUT2_DIVIDE   = %7d";
static const char *ng11 = "CLKOUT3_DIVIDE   = %7d";
static const char *ng12 = "CLKOUT0_PERIOD   = %7d";
static unsigned int ng13[] = {1500U, 0U};
static const char *ng14 = "CLKOUT1_PERIOD   = %7d";
static const char *ng15 = "CLKOUT2_PERIOD   = %7d";
static unsigned int ng16[] = {24000U, 0U};
static const char *ng17 = "CLKOUT3_PERIOD   = %7d";
static unsigned int ng18[] = {6000U, 0U};
static const char *ng19 = "CLKOUT4_PERIOD   = %7d";
static unsigned int ng20[] = {3000U, 0U};
static const char *ng21 = "############################################################\n";
static const char *ng22 = "############# MMCME2_ADV Parameters #############\n";
static const char *ng23 = "MMCM_VCO_MIN_PERIOD   = %7.3f";
static const char *ng24 = "MMCM_VCO_MAX_PERIOD   = %7.3f";
static const char *ng25 = "MMCM_MULT_F_MID       = %7.3f";
static const char *ng26 = "MMCM_EXPECTED_PERIOD  = %7.3f";
static const char *ng27 = "MMCM_MULT_F           = %7.3f";
static const char *ng28 = "CLKOUT3_PERIOD_NS     = %7.3f";
static const char *ng29 = "MMCM_VCO_FREQ (MHz)   = %7.3f";
static const char *ng30 = "MMCM_VCO_PERIOD       = %7.3f";
static const char *ng31 = "#################################################\n";
static unsigned int ng32[] = {8191U, 0U};
static int ng33[] = {1, 0};
...
LAB2:    xsi_set_current_line(160, ng0);
    ...
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng4, 2, t0, (char)114, t4, 64);
    ...
    t1 = (t0 + 1152);
    t2 = *((char **)t1);
    xsi_vlogfile_write(1, 0, 0, ng6, 2, t0, (char)119, t2, 32);
    ...
    t1 = (t0 + 1560);
    t2 = *((char **)t1);
    xsi_vlogfile_write(1, 0, 0, ng8, 2, t0, (char)119, t2, 32);
    ...
    t1 = (t0 + 1832);
    t2 = *((char **)t1);
    xsi_vlogfile_write(1, 0, 0, ng10, 2, t0, (char)119, t2, 32);
    xsi_set_current_line(170, ng0);
    t1 = (t0 + 1968);
    t2 = *((char **)t1);
    xsi_vlogfile_write(1, 0, 0, ng11, 2, t0, (char)119, t2, 32);
    xsi_set_current_line(171, ng0);
    t1 = ((char*)((ng13)));
    xsi_vlogfile_write(1, 0, 0, ng12, 2, t0, (char)119, t1, 32);
    xsi_set_current_line(172, ng0);
    t1 = ((char*)((ng13)));
    xsi_vlogfile_write(1, 0, 0, ng14, 2, t0, (char)119, t1, 32);
    xsi_set_current_line(173, ng0);
    t1 = ((char*)((ng16)));
    xsi_vlogfile_write(1, 0, 0, ng15, 2, t0, (char)119, t1, 32);
    xsi_set_current_line(174, ng0);
    t1 = ((char*)((ng18)));
    xsi_vlogfile_write(1, 0, 0, ng17, 2, t0, (char)119, t1, 32);
    xsi_set_current_line(175, ng0);
    t1 = ((char*)((ng20)));
    xsi_vlogfile_write(1, 0, 0, ng19, 2, t0, (char)119, t1, 32);
...
static void Initial_300_4(char *t0)
{
    char t4[8];
    char *t1;
    char *t2;
...
LAB2:    xsi_set_current_line(301, ng0);
    ...
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng23, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(303, ng0);
    t1 = (t0 + 4416);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng24, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(304, ng0);
    t1 = (t0 + 4552);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng25, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(305, ng0);
    t1 = (t0 + 4688);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng26, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(306, ng0);
    t1 = (t0 + 4824);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng27, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(307, ng0);
    t1 = (t0 + 3736);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng28, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(308, ng0);
    t1 = (t0 + 4960);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    t5 = (t3 * 1000.0000000000000);
    *((double *)t4) = t5;
    xsi_vlogfile_write(1, 0, 0, ng29, 2, t0, (char)114, t4, 64);
    xsi_set_current_line(309, ng0);
    t1 = (t0 + 5096);
    t2 = *((char **)t1);
    t3 = *((double *)t2);
    *((double *)t4) = t3;
    xsi_vlogfile_write(1, 0, 0, ng30, 2, t0, (char)114, t4, 64);
...
LAB6:    xsi_set_current_line(408, ng0);
    ...
    t5 = ((char*)((ng33)));
    memset(t13, 0, 8);
    xsi_vlog_unsigned_lshift(t13, 13, t4, 13, t5, 32);
    t11 = (t0 + 13248);
    xsi_vlogvar_wait_assign_value(t11, t13, 0, 0, 13, 100000LL);
...
LAB5:    xsi_set_current_line(406, ng0);
    t11 = ((char*)((ng32)));
    t12 = (t0 + 13248);
    xsi_vlogvar_wait_assign_value(t12, t11, 0, 0, 13, 100000LL);
    goto LAB7;

}

static void Cont_410_7(char *t0)
{
    char t5[8];
    char *t1;
    char *t2;
...
static void Cont_412_8(char *t0)
{
    char t4[8];
    char t22[8];
    char t50[8];
...
static void Always_414_9(char *t0)
{
    char t13[8];
    char *t1;
    char *t2;
...
static void Cont_420_10(char *t0)
{
    char t5[8];
    char *t1;
    char *t2;
...
extern void work_m_10841900254457170150_1173984779_init()
{
	static char *pe[] = {(void *)Initial_159_0,(void *)Cont_199_1,(void *)Cont_206_2,(void *)Cont_207_3,(void *)Initial_300_4,(void *)Cont_401_5,(void *)Always_404_6,(void *)Cont_410_7,(void *)Cont_412_8,(void *)Always_414_9,(void *)Cont_420_10,(void *)implSig1_execute,(void *)implSig2_execute,(void *)implSig3_execute,(void *)implSig4_execute,(void *)implSig5_execute,(void *)implSig6_execute,(void *)implSig7_execute,(void *)implSig8_execute,(void *)implSig9_execute,(void *)implSig10_execute,(void *)implSig11_execute,(void *)implSig12_execute,(void *)implSig13_execute,(void *)implSig14_execute,(void *)implSig15_execute,(void *)implSig16_execute,(void *)implSig17_execute,(void *)implSig18_execute,(void *)implSig19_execute};
	xsi_register_didat("work_m_10841900254457170150_1173984779", "isim/PicoTestbench_isim_beh.exe.sim/work/m_10841900254457170150_1173984779.didat");
