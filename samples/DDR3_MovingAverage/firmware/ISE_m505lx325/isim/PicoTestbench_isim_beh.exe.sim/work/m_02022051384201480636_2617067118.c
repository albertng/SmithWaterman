...
static int ng14[] = {4, 0};
static int ng15[] = {0, 0};
static int ng16[] = {289, 0};
static int ng17[] = {256, 0};
static int ng18[] = {1, 0};
static int ng19[] = {32, 0};
static int ng20[] = {259, 0};
...
LAB2:    xsi_set_current_line(382, ng0);
    ...
    t2 = (t0 + 15688U);
    t7 = *((char **)t2);
    xsi_vlogtype_concat(t3, 301, 301, 4U, t7, 12, t6, 256, t5, 32, t4, 1);
    t2 = (t0 + 42408);
    t8 = (t2 + 56U);
    t9 = *((char **)t8);
    t10 = (t9 + 56U);
    t11 = *((char **)t10);
    xsi_vlog_bit_copy(t11, 0, t3, 0, 301);
    xsi_driver_vfirst_trans(t2, 0, 300);
    t12 = (t0 + 41192);
    *((int *)t12) = 1;
...
LAB2:    xsi_set_current_line(387, ng0);
    ...
    t7 = ((char*)((ng5)));
    t8 = ((char*)((ng17)));
    xsi_vlog_get_indexed_partselect(t3, 256, t4, ((int*)(t6)), 2, t7, 32, 1, t8, 32, 1, 1);
    t9 = (t0 + 42600);
    t10 = (t9 + 56U);
    t11 = *((char **)t10);
    t12 = (t11 + 56U);
    t13 = *((char **)t12);
    xsi_vlog_bit_copy(t13, 0, t3, 0, 256);
...
LAB2:    xsi_set_current_line(520, ng0);
    ...
    t2 = (t0 + 26888U);
    t7 = *((char **)t2);
    xsi_vlogtype_concat(t3, 271, 271, 4U, t7, 12, t6, 256, t5, 2, t4, 1);
    t2 = (t0 + 43816);
    t8 = (t2 + 56U);
    t9 = *((char **)t8);
    t10 = (t9 + 56U);
    t11 = *((char **)t10);
    xsi_vlog_bit_copy(t11, 0, t3, 0, 271);
    xsi_driver_vfirst_trans(t2, 0, 270);
    t12 = (t0 + 41496);
    *((int *)t12) = 1;
...
extern void work_m_02022051384201480636_2617067118_init()
{
	...
	xsi_register_didat("work_m_02022051384201480636_2617067118", "isim/PicoTestbench_isim_beh.exe.sim/work/m_02022051384201480636_2617067118.didat");
