...
LAB16:    t18 = (t0 + 52720);
    ...
    t27 = (t26 + 56U);
    t28 = *((char **)t27);
    xsi_vlog_bit_copy(t28, 0, t3, 0, 256);
    xsi_driver_vfirst_trans(t18, 0, 255);
    t29 = (t0 + 51424);
    *((int *)t29) = 1;
...
LAB12:    xsi_vlog_unsigned_bit_combine(t3, 256, t19, 256, t24, 256);
    goto LAB16;

LAB14:    memcpy(t3, t19, 64);
    goto LAB16;
...
static void Always_3708_57(char *t0)
{
    char t4[8];
    char t5[8];
    char t8[8];
